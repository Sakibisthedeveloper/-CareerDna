...
-- Speech History table to persist cleft palate speech transcriptions and corrections
...
-- Allow public inserts for anonymous transcriptions
create policy "Anyone can insert speech history"
  on speech_history for insert
  with check (true);

-- Allow public read access to display history
create policy "Public read access for speech history"
  on speech_history for select
  using (true);

-- Allow public updates to save manual corrections
create policy "Anyone can update speech history"
  on speech_history for update
  using (true);
